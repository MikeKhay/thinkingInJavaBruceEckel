package chapter11.collections.task20;

import java.io.FileNotFoundException;
import java.util.*;

public class CountVowelsLetterSaveMap {
    public static void main(String[] args) throws FileNotFoundException {
            ...
            for (String oneLaterWord : oneWord){
                for (String oneLaterVowels : vowels){
                    if(oneLaterWord.equals(oneLaterVowels)){
                        Integer freq = map.get(oneLaterWord);
                        map.put(oneLaterWord, freq == null ? 1 : freq + 1);
        ...
        System.out.println("Count used vowels letter in text : ");
