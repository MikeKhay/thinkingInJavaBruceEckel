...
public class Countries extends AbstractMap<String, String>{
    ...
    private int countriesSize = DATA.length;
    public Countries() {
        super();
    }
    ...
    public static class Country implements Entry<String,String> {
        private int index=0;
    ...
    public class CountrySet extends AbstractSet<Entry<String,String>> {
        private int index = 0;
